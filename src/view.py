...
class UIComponents:
    ...
    def _setup_ui(self):
        ...
        self._label1 = ttk.Label(self._frame1, font=Config.FONT)
        self._label2 = ttk.Label(self._frame2, font=Config.FONT)
        self._panel1 = ttk.Label(self._frame1)
        self._panel2 = ttk.Label(self._frame2)
    ...
    def _layout_ui(self):
        ...
        self._label1.grid(row=1, column=0, pady=5)
        self._label2.grid(row=1, column=0, pady=5)
        self._status_label.grid(row=2, column=0, pady=(0, 5), columnspan=2)
        self._progress_frame.grid(row=3, column=0, pady=(0, 10), padx=10, columnspan=2, sticky="ew")
        ...
        self._pending_count_label.grid(row=4, column=0, pady=(0, 10), columnspan=2)
